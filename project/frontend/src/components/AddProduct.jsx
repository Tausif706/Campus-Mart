...
function AddProduct() {
    ...
    const [pimage, setpimage] = useState('');
    const [pimage2, setpimage2] = useState('');
    const [pnumber, setpnumber] = useState(''); // Add pnumber state
    ...
    const handleApi = () => {
        navigator.geolocation.getCurrentPosition((position) => {
            ...
            formData.append('pimage', pimage);
            formData.append('pimage2', pimage2);
            formData.append('pnumber', pnumber); // Add pnumber to FormData
            formData.append('userId', localStorage.getItem('userId'));
    ...
    return (
        <div>
            ...
            <div className="p-3">
                ...
                <label> Product Number </label> {/* Add input field for pnumber */}
                <input className="form-control" type="text" value={pnumber} onChange={(e) => setpnumber(e.target.value)} />
                <button onClick={handleApi} className="btn btn-primary mt-3"> SUBMIT </button>
            </div>
        </div>
    );
