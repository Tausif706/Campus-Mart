...
//       window.open(`https://api.whatsapp.com/send?phone=${number}&text=Hello%20World`, '_blank');
//     }
//   return (<>
//     <Header />
...
//                 {/* <ReactWhatsapp number='8327717540' message="hello world" /> */}
//                 <button
//                   type="button"
//                   onClick={whatsApp(+918327717540)}
...
function ProductDetail() {
    ...
    const whatsApp = (number,name) => {
      console.log(number)
      window.open(`https://api.whatsapp.com/send?phone=${number}&text=Hello%20I%20am%20interested%20in%20buying%20${name}`, '_blank');
  };
                            ...
                            <div className="items-start justify-between lg:flex lg:space-x-8">
                                ...
                                <div className="flex shrink-0 flex-col lg:w-[430px] xl:w-[470px] 2xl:w-[480px]">
                                    ...
                                    <div className="space-y-2.5 pt-1.5 md:space-y-3.5 lg:pt-3 xl:pt-4">
                                        <button
                                            type="button"
                                            onClick={() => whatsApp(product.pnumber,product.pname)}
                                            className="w-full rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                                        >
                                            Contact Us
                                        </button>
