...
//     const category = req.body.category || "Bikes";
...
module.exports.addProduct = (req, res) => {
    ...
    const pimage = req.files.pimage[0].path;
    const pimage2 = req.files.pimage2[0].path;
    const pnumber = req.body.pnumber; // Add pnumber extraction
    const addedBy = req.body.userId;

    const product = new Products({
        pname, pdesc, price, category, pimage, pimage2, addedBy,pnumber, pLoc: {
            type: 'Point', coordinates: [plat, plong]
        }
         // Include pnumber in the product object
    });
